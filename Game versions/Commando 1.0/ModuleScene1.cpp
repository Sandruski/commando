...
update_status ModuleScene1::Update()
{
	...
	App->render->Blit(App->TEX->graphics1, w, h, &background);

	current_animation = &ammo_grenades_colours;
	r = current_animation->GetCurrentFrame();
	if (App->player->detectionitem[1] == false)
	App->render->Blit(App->TEX->items1, 153, 2464 - 2656, &r);
	if (App->player->detectionitem[2] == false)
	App->render->Blit(App->TEX->items1, 33, 1936 - 2656, &r);
	if (App->player->detectionitem[4] == false)
	App->render->Blit(App->TEX->items1, 30, 944 - 2656, &r);
	if (App->player->detectionitem[5] == false)
	App->render->Blit(App->TEX->items1, 44, 706 - 2656, &r);
	if (App->player->detectionitem[6] == false)
	App->render->Blit(App->TEX->items1, 1, 464 - 2656, &r);
	if (App->player->detectionitem[7] == false)
	App->render->Blit(App->TEX->items1, 155, 218 - 2656, &r);

	current_animation = &ammo_specialgrenade1;
	r = current_animation->GetCurrentFrame();
	if (App->player->detectionitem[0] == false)
	App->render->Blit(App->TEX->items1, 151, 2625 - 2656, &r);
	if (App->player->detectionitem[3] == false)
	App->render->Blit(App->TEX->items1, 185, 1149 - 2656, &r);

	current_animation = &radio;
	r = current_animation->GetCurrentFrame();
	if (App->player->detectionitem[8] == true)
		App->render->Blit(App->TEX->items1, 225, 1731 - 2656, &r);



	if(roomA == true)
		App->render->Blit(App->TEX->items1, 150, 2372 - 2656, &Secret_Room);
	if (roomB == true)
		App->render->Blit(App->TEX->items1, 9, 2051 - 2656, &Secret_Room);
	if (roomC == true)
		App->render->Blit(App->TEX->items1, 217, 1426 - 2656, &Secret_Room);
	if (roomD == true)
		App->render->Blit(App->TEX->items1, 121, 1056 - 2656, &Secret_Room);
	if (roomE == true)
		App->render->Blit(App->TEX->items1, 233, 522 - 2656, &Secret_Room);
	...
	if (App->player->position.y <= 1550 - 2656 && contador < 120) { /* && App->player->position.y >= 1300 - 2656 */
		if (w_m > 105) {
			...
			r = current_animation->GetCurrentFrame();
			App->render->Blit(App->TEX->moto1, w_m, 1345 - 2656, &r);
			w_m--;
		}
	...
	if (App->player->position.y == 210 - 2656 && added) {
		//Soldier shield
		added = false;
...
//		App->fade->FadeToBlack(this, App->CinematicRadio, 1);
	...
	if (App->player->position.y <= 15 - 2656 && winB == true)
		cont6 = true;
	...
	if (App->player->position.y <= 120 - 2656) {
		...
		App->render->Blit(App->TEX->end_door1, 88, -2656, &reee);
	}
	if (yeee) {
		current_animation1 = &door;
		reee = current_animation1->GetCurrentFrame();
	...
	if (App->player2->twoplayerson == true) {
		...
		App->render->Blit(App->TEX->newmodetxt, 190, 150, &App->player2->torevive2);
		if (torevivecheck2 == false)
		App->render->Blit(App->TEX->newmodetxt, 102, 2212 - 2656, &App->player2->torevive2);
		if (torevivecheck3 == false)
		App->render->Blit(App->TEX->newmodetxt, 84, 1502 - 2656, &App->player2->torevive2);
		if (torevivecheck4 == false)
		App->render->Blit(App->TEX->newmodetxt, 243, 708 - 2656, &App->player2->torevive2);
	}
