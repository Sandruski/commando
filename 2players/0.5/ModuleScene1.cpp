...
bool ModuleScene1::Start()
{
	...
	App->player2->current_animation = &App->player2->idleF;
	cont6 = false;
	cont5 = 0;
...
update_status ModuleScene1::Update()
{
	...
	if ((App->player->position.y <= 60 - 2656 && winB == true && App->player2->twoplayerson == false) || (App->player2->twoplayerson == true && App->player->position.y <= 60 - 2656 && winB == true && App->player2->position.y <= 60 - 2656))
		cont6 = true;
