...
update_status ModuleInput::PreUpdate()
{
	...
	if (SDL_GameControllerGetButton(controller2, SDL_CONTROLLER_BUTTON_X) == 1) {
		if (buttonX2 == KEY_IDLE)
			buttonX2 = KEY_DOWN;
		else
			buttonX2 = KEY_REPEAT;
	}
	...
	{
		if (buttonX2 == KEY_REPEAT || buttonX2 == KEY_DOWN)
			buttonX2 = KEY_UP;
		else
			buttonX2 = KEY_IDLE;
	}
	...
	if (SDL_GameControllerGetButton(controller2, SDL_CONTROLLER_BUTTON_BACK) == 1) {
		if (buttonBack2 == KEY_IDLE)
			buttonBack2= KEY_DOWN;
		else
			buttonBack2 = KEY_REPEAT;
	}
	else
	{
		if (buttonBack2 == KEY_REPEAT || buttonBack2 == KEY_DOWN)
			buttonBack2 = KEY_UP;
		else
			buttonBack2 = KEY_IDLE;
	}
